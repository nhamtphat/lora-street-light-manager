                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="mt-3 info-box">
                                ...
                                <span title="UID: {{$lamp->uid}}" class="mx-1 info-box-icon bg-warning"><i
                                        class="fa fa-lightbulb-o"></i></span>
                                @else
                                @if($street->is_on())
                                <span title="UID: {{$lamp->uid}}" class="mx-1 info-box-icon bg-success"><i
                                        class="fa fa-lightbulb-o"></i></span>
                                @else
                                <span title="UID: {{$lamp->uid}}" class="mx-1 info-box-icon bg-default"><i
                                        class="fa fa-lightbulb-o"></i></span>
                                @endif
                                @endif
                                @endforeach
